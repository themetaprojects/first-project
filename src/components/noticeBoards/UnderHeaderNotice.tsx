...
export const UnderHeaderNotice = () => {
    ...
    return (
        <>
            <div className='presale-notice'>
                <h1>About Us:</h1>
                <p>There are many launchpads in the crypto industry, but most of them are out of the reach of the general public. We are developing this platform to fulfill the gap between the true crypto projects and the general public, which will be a game-changer for the industry.
                </p>
                <p>We will bring in many exciting projects from "Metaverse" and "NFTs & Collectibles" to "Play To Earn" and "DeFi".
                </p>
                <h2>Lottery!!! Chance to win 10K Tokens</h2>
