...
import thebullspadlightblackpng from "../images/7-the-bulls-pad-light-black.png"
import brownieConfig from "../brownie-config.json"
import helperConfig from "../helper-config.json"
import { FirstModal } from './noticeBoards/FirstModal';
...
const pages = [
    ...
    { name: 'project-0', link: '/projects/0' }
];
...
const ResponsiveAppBar = () => {
    ...
    const busdTokenAddress = (
        chainId ?
            (((String(chainId) == '42') || (String(chainId) == '97') || (String(chainId) == '56')) ?
                brownieConfig["networks"][helperConfig[String(chainId)]]["busd_token"] :
                constants.AddressZero) :
            constants.AddressZero
    )
    ...
    // let numberMain = 2;
    console.log(`Header2 chainId: ${chainId}`)
    useEffect(() => {
        chainId ?
            ((String(chainId) == '42') || (String(chainId) == '97') || (String(chainId) == '56')) ?
                                    ...
                                    <Toolbar disableGutters>
                                        ...
                                        >
                                            ...
                                            <div className="logo-name">
                                                <Link style={{ padding: "0" }} to="/" className='logo-link'>
                                                    <h3>The Bulls Pad</h3>
                                                    <img src={thebullspadlightblackpng} className="the-bulls-pad-logo" />
                                                </Link>
                                        ...
                                        <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
                                            ...
                                            <Link style={{ paddingTop: "5px" }} to="/" className='logo-link'>
                                                <img src={thebullspadlightblackpng} className="the-bulls-pad-logo" />
                                            </Link>
                                            <Menu
                                                id="menu-appbar"
