...
interface YourWalletProps {
    supportedPreSaleTokens: Array<Token>
}


export const Project = ({ supportedPreSaleTokens }: YourWalletProps) => {
    ...
    const dappTokenAddress = supportedPreSaleTokens[0].address
                            ...
                            <div>
                                {(connectedToMetaMask && (formattedEthBalance > 0)
                                    ...
                                    <>
                                        ...
                                        {preSaleAllocationStatus ? <AllocatedAmountToParticipate supportedTokens={supportedPreSaleTokens} preSaleNumber={preSaleNumber} /> : <></>}
                                        ...
                                        {(preSaleFundEachPreSaleNumberStatus ||
                                            ...
                                            (
                                                <>
                                                    ...
                                                    <ParticipateTab supportedPreSaleTokens={supportedPreSaleTokens} preSaleNumber={preSaleNumber} />
                                                </>
                                            ) : <></>}
