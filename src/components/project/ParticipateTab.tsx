...
export const ParticipateTab = ({ supportedPreSaleTokens, preSaleNumber }: SupportedTokensProps) => {
            ...
            <Box className={classes.box}>
                <TabContext value={selectedTokenIndex.toString()} >
                    ...
                    <TabList onChange={handleChange} aria-label="stake form tabs">
                        {supportedPreSaleTokens.map((token, index) => {
                        ...
                        return (
                            <TabPanel value={index.toString()} key={index}>
                                <div className={classes.tabContent}>
                                    <WalletBalance token={supportedPreSaleTokens[selectedTokenIndex]} />
                                    {/* <UnStakeForm token={supportedTokens[selectedTokenIndex]} /> */}
                                    <PreSaleFormEachPreSale token={supportedPreSaleTokens[selectedTokenIndex]} preSaleNumber={preSaleNumber} />
                                </div>
                            </TabPanel>
                        )
                    })}
