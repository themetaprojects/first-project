...
import { UnderHeaderNotice } from "./noticeBoards/UnderHeaderNotice"
...
export const Main = ({ elementNumber }: elementNumber) => {
    ...
    const { dappTokenAddress: dapp_token_address, busdTokenAddress } = useContext(MyContext)
    ...
    return (<>
        ...
        <Container maxWidth="md" sx={{ mt: 0 }}>
            {/* in the future also add our token in this grid to display balance */}
            {/* <UnderHeaderNotice />
            ...
            <Routes>
                ...
                <Route path='projects/:id' element={<Project supportedPreSaleTokens={supportedPreSaleTokens} />}></Route>
